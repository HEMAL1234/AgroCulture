	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>Nahidul Hasan</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:nahidulhemal123@gmail.com" style="color:white">nahidulhemal123@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			...
			<div class="footer-icons">
				<a  href="https://www.facebook.com/nahidulhasan.hemal.9/"><i style="margin-left: 0;margin-top:5px;"class="fa fa-facebook"></i></a>
